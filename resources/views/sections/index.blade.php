        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Seções</li>
                </ol>
            </nav>
        </div>
        <button class="btn btn-primary create-entity mb-auto" data-action-url="/ajax/sections">Novo Seção</button>
    </div>
@stop
...
@section('content')
    <div class="card">
        <div class="card-header">
            <span class="">Lista de Seções</span>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="sections-table" class="table data-table table-striped table-bordered" style="width:100%">
    ...
    <script>
        $(document).ready(function() {
            $('#sections-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route('ajax.sections.index') }}',
                columns: [{
                        data: 'sequential',
                        name: 'sequential'
                    },
