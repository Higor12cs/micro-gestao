...
@section('content_header')
    <div class="d-flex justify-content-between">
        ...
        <button class="btn btn-primary create-entity mb-auto" data-action-url="/ajax/groups">Novo Grupo</button>
    </div>
@stop
...
@section('content')
    <div class="card">
        <div class="card-header">
            <span class="">Lista de Grupos</span>
        </div>
        <div class="card-body">
            <div class="table-responsive text-nowrap">
                <table id="groups-table" class="table data-table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr>
